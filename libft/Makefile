...
#    Updated: 2023/05/11 10:21:40 by jsteenpu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c \
		...
		ft_split.c ft_itoa.c ft_strmapi.c ft_atoi.c \
		ft_putchar_fd.c ft_striteri.c ft_putstr_fd.c ft_putendl_fd.c  ft_putnbr_fd.c
